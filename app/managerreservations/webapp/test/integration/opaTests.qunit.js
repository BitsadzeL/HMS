...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "hms/manager/managerreservations/test/integration/ReservationsListJourney.gen",
    "hms/manager/managerreservations/test/integration/ReservationsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
