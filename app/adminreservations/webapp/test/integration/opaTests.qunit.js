...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "hms/admin/adminreservations/test/integration/ReservationsListJourney.gen",
    "hms/admin/adminreservations/test/integration/ReservationsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
