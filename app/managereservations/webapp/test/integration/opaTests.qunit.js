...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "hms/managereservations/managereservations/test/integration/ReservationsListJourney.gen",
    "hms/managereservations/managereservations/test/integration/ReservationsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
