...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "hms/managemanagers/managemanagers/test/integration/ManagersListJourney.gen",
    "hms/managemanagers/managemanagers/test/integration/ManagersObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
