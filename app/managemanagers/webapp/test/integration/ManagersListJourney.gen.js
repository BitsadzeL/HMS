...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ManagersListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheManagersListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheManagersListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheManagersListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheManagersListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheManagersListGenerated.onTable().iPressRow(0);
            Then.onTheManagersObjectPageGenerated.iSeeThisPage();
