...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("GuestsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheGuestsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheGuestsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheGuestsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheGuestsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheGuestsListGenerated.onTable().iPressRow(0);
            Then.onTheGuestsObjectPageGenerated.iSeeThisPage();
