...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("RoomsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheRoomsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheRoomsListGenerated.onFilterBar().iChangeSearchField("Search Term");
