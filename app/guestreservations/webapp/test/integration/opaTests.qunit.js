...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "hms/guest/guestreservations/test/integration/ReservationsListJourney.gen",
    "hms/guest/guestreservations/test/integration/ReservationsObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
