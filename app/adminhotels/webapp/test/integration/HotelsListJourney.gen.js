...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("HotelsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheHotelsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheHotelsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheHotelsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheHotelsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheHotelsListGenerated.onTable().iPressRow(0);
            Then.onTheHotelsObjectPageGenerated.iSeeThisPage();
